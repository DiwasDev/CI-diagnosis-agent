...
| State | Cost | Status | Reason & Calculation |
|-------|------|--------|---------------------|
| S1 | **$8.3** | ASSUMED | **Correct action.** 5-min spot-check × ($100 / 60) = **$8.3**. |
| S2 | **$8.3** | ASSUMED | **Correct action.** Project config (pyproject.toml, etc.) is within the "Fix Code" action scope per policy. Same automation cost as S1 |
| S3 | **$75.07** | ASSUMED | Wrong action. Same misdiagnosis chain. Code patch does not resolve dependency failure. |
| S4 | **$5.00** | ASSUMED | **Correct action.** Static analysis failure is resolved by lint/code patch. Same automation cost as S1. |
...
| **Fix Code** | **$5.00** | **$5.00** | $75.07 | **$5.00** | $75.07 | $75.07 | $75.07 |

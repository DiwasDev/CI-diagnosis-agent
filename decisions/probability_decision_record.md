...
Limitation — Model-Assumption Circularity:
The 500-case benchmark is generated by sampling hidden states from the agent's 
priors and evidence from the agent's likelihood tables (src/generate_benchmark_data.py). 
This evaluates policy performance under the assumed generative model. It does NOT 
